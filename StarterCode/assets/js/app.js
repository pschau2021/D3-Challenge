...
// Declare function for updating x&y-axes upon selection
...
d3.csv("http://localhost:8000/StarterCode/assets/data/data.csv").then(function(myData, err) {
    if (err) throw err;
    ...
    // Select axis scales based on initial selected values
    var bottomAxis = d3.axisBottom(xLinearScale);
    var leftAxis = d3.axisLeft(yLinearScale); 

    // Append x&y-axes to SVG group 
    ...
    // Assign click handlers to x-axis labels
    xLabels.selectAll("text")
        .on("click", function() {
            ...
            if (value !== chosenXAxis) {
                ...
                // Change class to active or inactive based on selection
                switch (chosenXAxis){
                    case "poverty": (
